...
namespace HelixToolkit.Wpf
{
    ...
    /// </remarks>
    public class CustomObjExporter : Exporter<ObjExporter.ObjWriters>
    {
        /// <summary>
        ...
        protected override ObjExporter.ObjWriters Create(Stream stream)
        {
            ...
            return new ObjExporter.ObjWriters { ObjWriter = writer, MaterialsWriter = materialWriter };
        }
        ...
        protected override void ExportModel(ObjExporter.ObjWriters writer, GeometryModel3D model, Transform3D transform)
        {
            ...
            {
                string matName = TextureFileName;
                writer.ObjWriter.WriteLine("usemtl {0}", matName);

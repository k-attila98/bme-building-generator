...
namespace BuildingGenerator.Prefabs.Walls
{
    public class HalfWall : IPrefab
    {
        public Transform GetTransform()
        {
            ...
            vertices1[2] = new Vertex(new Vector3(2, 2, -0.04f));
            ...
            vertices2[1] = new Vertex(new Vector3(2, 2, -0.04f));
            vertices2[2] = new Vertex(new Vector3(0, 2, -0.04f));
            ...
            vertices3[2] = new Vertex(new Vector3(0, 2, 0.04f));
            ...
            vertices4[1] = new Vertex(new Vector3(0, 2, 0.04f));
            vertices4[2] = new Vertex(new Vector3(2, 2, 0.04f));
            ...
            vertices5[2] = new Vertex(new Vector3(0, 2, -0.04f));
            ...
            vertices6[1] = new Vertex(new Vector3(0, 2, -0.04f));
            vertices6[2] = new Vertex(new Vector3(0, 2, 0.04f));
            ...
            vertices7[2] = new Vertex(new Vector3(2, 2, 0.04f));
            ...
            vertices8[1] = new Vertex(new Vector3(2, 2, 0.04f));
            vertices8[2] = new Vertex(new Vector3(2, 2, -0.04f));
            ...
            vertices9[0] = new Vertex(new Vector3(0, 2, -0.04f));
            vertices9[1] = new Vertex(new Vector3(2, 2, -0.04f));
            vertices9[2] = new Vertex(new Vector3(2, 2, 0.04f));
            ...
            vertices10[0] = new Vertex(new Vector3(0, 2, -0.04f));
            vertices10[1] = new Vertex(new Vector3(2, 2, 0.04f));
            vertices10[2] = new Vertex(new Vector3(0, 2, 0.04f));
